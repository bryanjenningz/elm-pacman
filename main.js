// elm-watch hot {"version":"1.1.0","targetName":"main","webSocketPort":35323}
"use strict";
(() => {
...
var $author$project$Main$boxWidth = $author$project$Main$gameWidth / 20;
...
var $author$project$Main$gameMap = $elm$core$List$concat(
	A2(
		...
		F2(
			function (y, row) {
				return A2(
					$elm$core$List$indexedMap,
					F2(
						function (x, gameMapChar) {
							return {_char: gameMapChar, x: x * $author$project$Main$boxWidth, y: y * $author$project$Main$boxWidth};
						}),
					row);
			}),
		A2(
			...
			_List_fromArray(
				['# ################ #', '#                  #', '# ### ######## ### #', '# #f            f# #', '# # #### ## #### # #', '#   #f        f#   #', '# ### ###  ### ### #', '   f#f        f#f   ', '# # ### #ii# ### # #', '#       #ii#       #', '# ### # #  # # ### #', '#f    #f    f#    f#', '##### ###  ### #####', '     f#f    f#f     ', '# # ### #### ### # #', '# #f            f# #', '# ###### ## ###### #', '#   ##f  ##  f##   #', '# #f   #f  f#   f# #', '# ################ #']))));
var $author$project$Main$initialFood = A2(
	$elm$core$List$map,
	function (_v0) {
		var x = _v0.x;
		var y = _v0.y;
	...
	return _Utils_Tuple2(
		{
			...
			enemies: _List_fromArray(
				[
					{changeDirectionTime: 0, direction: $author$project$Main$Up, isLockedOn: true, path: _List_Nil, x: $author$project$Main$boxWidth * 8, y: $author$project$Main$boxWidth * 7},
					{changeDirectionTime: 0, direction: $author$project$Main$Up, isLockedOn: false, path: _List_Nil, x: $author$project$Main$boxWidth * 11, y: $author$project$Main$boxWidth * 7},
					{changeDirectionTime: 0, direction: $author$project$Main$Up, isLockedOn: true, path: _List_Nil, x: $author$project$Main$boxWidth * 8, y: $author$project$Main$boxWidth * 11},
					{changeDirectionTime: 0, direction: $author$project$Main$Up, isLockedOn: false, path: _List_Nil, x: $author$project$Main$boxWidth * 11, y: $author$project$Main$boxWidth * 11}
				]),
...
var $author$project$Main$overlapping = F2(
	function (p1, p2) {
		return ((_Utils_cmp(p1.x, p2.x + $author$project$Main$boxWidth) < 0) && (_Utils_cmp(p1.x + $author$project$Main$boxWidth, p2.x) > 0)) && ((_Utils_cmp(p1.y, p2.y + $author$project$Main$boxWidth) < 0) && (_Utils_cmp(p1.y + $author$project$Main$boxWidth, p2.y) > 0));
	});
...
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				(_Utils_eq(model.food, _List_Nil) || A2(
				$elm$core$List$any,
				$author$project$Main$overlapping(model.player),
				model.enemies)) ? $elm$core$Platform$Sub$none : $elm$browser$Browser$Events$onAnimationFrame(
...
var $author$project$Main$bulletDirection = function (key) {
	switch (key) {
		case 'w':
...
var $author$project$Main$playerDirection = function (keysDown) {
	return A2($elm$core$Set$member, 'ArrowUp', keysDown) ? $elm$core$Maybe$Just($author$project$Main$Up) : (A2($elm$core$Set$member, 'ArrowDown', keysDown) ? $elm$core$Maybe$Just($author$project$Main$Down) : (A2($elm$core$Set$member, 'ArrowLeft', keysDown) ? $elm$core$Maybe$Just($author$project$Main$Left) : (A2($elm$core$Set$member, 'ArrowRight', keysDown) ? $elm$core$Maybe$Just($author$project$Main$Right) : $elm$core$Maybe$Nothing)));
};
...
var $author$project$Main$moveSpeed = 2;
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$Main$directionDeltas = function (direction) {
	return A3(
		$elm$core$Tuple$mapBoth,
		$elm$core$Basics$mul($author$project$Main$moveSpeed),
		$elm$core$Basics$mul($author$project$Main$moveSpeed),
		function () {
			switch (direction.$) {
				case 'Up':
...
var $author$project$Main$gameMapWalls = A2(
	$elm$core$List$filter,
	A2(
		$elm$core$Basics$composeR,
		function ($) {
...
var $author$project$Main$updateBullets = F2(
	function (enemies, bullets) {
		return A2(
			$elm$core$List$map,
			function (bullet) {
				var _v0 = $author$project$Main$directionDeltas(bullet.direction);
				var dx = _v0.a;
				var dy = _v0.b;
				return _Utils_update(
					bullet,
					{x: bullet.x + dx, y: bullet.y + dy});
			},
			A2(
				$elm$core$List$filter,
				function (bullet) {
					return (!A2(
						$elm$core$List$any,
						$author$project$Main$overlapping(bullet),
						enemies)) && ((!A2(
						$elm$core$List$any,
						$author$project$Main$overlapping(bullet),
						$author$project$Main$gameMapWalls)) && (((bullet.x >= 0) && (_Utils_cmp(bullet.x, $author$project$Main$gameWidth) < 0)) && ((bullet.y >= 0) && (_Utils_cmp(bullet.y, $author$project$Main$gameWidth) < 0))));
				},
				bullets));
	});
var $author$project$Main$changeDirectionTime = 500;
var $elm$core$Basics$clamp = F3(
	function (low, high, number) {
		return (_Utils_cmp(number, low) < 0) ? low : ((_Utils_cmp(number, high) > 0) ? high : number);
	});
var $author$project$Main$enemyRespawn = {x: ($author$project$Main$gameWidth / 2) - ($author$project$Main$boxWidth / 2), y: ($author$project$Main$gameWidth / 2) - ($author$project$Main$boxWidth / 2)};
...
var $author$project$Main$normalize = function (x) {
	return (($elm$core$Basics$round(x) / $elm$core$Basics$round($author$project$Main$boxWidth)) | 0) * $author$project$Main$boxWidth;
};
var $author$project$Main$Queue = F2(
	function (a, b) {
		return {$: 'Queue', a: a, b: b};
	});
var $author$project$Main$queueAdd = F2(
	function (newest, _v0) {
		var oldestToNewer = _v0.a;
		var newestToOlder = _v0.b;
		return A2(
			$author$project$Main$Queue,
			oldestToNewer,
			A2($elm$core$List$cons, newest, newestToOlder));
	});
var $author$project$Main$queueEmpty = A2($author$project$Main$Queue, _List_Nil, _List_Nil);
var $author$project$Main$queueNext = function (queue) {
	queueNext:
	while (true) {
		if (!queue.a.b) {
			if (!queue.b.b) {
				return _Utils_Tuple2(
					$elm$core$Maybe$Nothing,
					A2($author$project$Main$Queue, _List_Nil, _List_Nil));
			} else {
				var newestToOlder = queue.b;
				var $temp$queue = A2(
					$author$project$Main$Queue,
					$elm$core$List$reverse(newestToOlder),
					_List_Nil);
				queue = $temp$queue;
				continue queueNext;
			}
			...
			var _v1 = queue.a;
			var oldest = _v1.a;
			var oldestToNewer = _v1.b;
			var newestToOlder = queue.b;
			return _Utils_Tuple2(
				$elm$core$Maybe$Just(oldest),
				A2($author$project$Main$Queue, oldestToNewer, newestToOlder));
		}
	}
};
var $author$project$Main$shortestPath_ = F3(
	function (visited, queue, destination) {
		shortestPath_:
		while (true) {
			var _v0 = $author$project$Main$queueNext(queue);
			if (_v0.a.$ === 'Nothing') {
				var _v1 = _v0.a;
				return _List_Nil;
			} else {
				if (!_v0.a.a.b) {
					...
					return _Utils_eq(
						_Utils_Tuple2(x, y),
						destination) ? $elm$core$List$reverse(path) : function (_v7) {
						var newVisited = _v7.a;
						var newQueue_ = _v7.b;
						return A3($author$project$Main$shortestPath_, newVisited, newQueue_, destination);
					}(
						A3(
							$elm$core$List$foldl,
							F2(
							...
							_Utils_Tuple2(visited, newQueue),
							A2(
								$elm$core$List$filter,
								function (_v4) {
									var newX = _v4.a;
									...
									return (!A2(
										...
										$elm$core$List$any,
										function (wall) {
											return _Utils_eq(wall.x, newX) && _Utils_eq(wall.y, newY);
										},
										$author$project$Main$gameMapWalls)) && (((newX >= 0) && (_Utils_cmp(newX + $author$project$Main$boxWidth, $author$project$Main$gameWidth) < 0)) && ((newY >= 0) && (_Utils_cmp(newY + $author$project$Main$boxWidth, $author$project$Main$gameWidth) < 0))));
								},
								A2(
									$elm$core$List$map,
									function (_v3) {
										var dx = _v3.a;
										var dy = _v3.b;
										return _Utils_Tuple2(x + (dx * $author$project$Main$boxWidth), y + (dy * $author$project$Main$boxWidth));
									},
									_List_fromArray(
										[
											_Utils_Tuple2(0, 1),
...
var $author$project$Main$shortestPath = F2(
	function (source, destination) {
		return A3(
			$author$project$Main$shortestPath_,
			$elm$core$Set$empty,
			A2(
				$author$project$Main$queueAdd,
				_List_fromArray(
					[
						A3($elm$core$Tuple$mapBoth, $author$project$Main$normalize, $author$project$Main$normalize, source)
					]),
				$author$project$Main$queueEmpty),
			destination);
	});
...
var $author$project$Main$wrapAround = function (x) {
	return A2(
		$elm$core$Basics$modBy,
		$elm$core$Basics$round($author$project$Main$gameWidth),
		$elm$core$Basics$round(x));
};
var $author$project$Main$updateEnemy = F4(
	function (timeNow, player, bullets, enemy) {
		var path = function () {
			var _v7 = enemy.path;
			if (!_v7.b) {
				return A2(
					$author$project$Main$shortestPath,
					_Utils_Tuple2(enemy.x, enemy.y),
				...
				var nextY = _v8.b;
				var remPath = _v7.b;
				return (_Utils_eq(enemy.x, nextX) && _Utils_eq(enemy.y, nextY)) ? remPath : enemy.path;
			}
		}();
		var newDirection = function () {
			var _v6 = A2($elm$core$Basics$modBy, 4, timeNow);
			switch (_v6) {
				case 0:
		...
		var hitByAnyBullets = A2(
			$elm$core$List$any,
			$author$project$Main$overlapping(enemy),
			bullets);
		var _v0 = A2(
		...
		var _v1 = _Utils_Tuple2(
			A3($elm$core$Basics$clamp, -$author$project$Main$moveSpeed, $author$project$Main$moveSpeed, pathX - enemy.x),
			A3($elm$core$Basics$clamp, -$author$project$Main$moveSpeed, $author$project$Main$moveSpeed, pathY - enemy.y));
		var pathDx = _v1.a;
		var pathDy = _v1.b;
		var _v2 = $author$project$Main$directionDeltas(enemy.direction);
		var oldDx = _v2.a;
		var oldDy = _v2.b;
		var _v3 = A3(
			$elm$core$Tuple$mapBoth,
			$author$project$Main$wrapAround,
			$author$project$Main$wrapAround,
			_Utils_Tuple2(enemy.x + oldDx, enemy.y + oldDy));
		var oldX = _v3.a;
		var oldY = _v3.b;
		var isOldDirectionOverlappingWalls = A2(
			$elm$core$List$any,
			$author$project$Main$overlapping(
				{x: oldX, y: oldY}),
			$author$project$Main$gameMapWalls);
		var _v4 = $author$project$Main$directionDeltas(newDirection);
		var newDx = _v4.a;
		var newDy = _v4.b;
		var _v5 = A3(
			$elm$core$Tuple$mapBoth,
			$author$project$Main$wrapAround,
			$author$project$Main$wrapAround,
			_Utils_Tuple2(enemy.x + newDx, enemy.y + newDy));
		var newX = _v5.a;
		var newY = _v5.b;
		var isNewDirectionOverlappingWalls = A2(
			$elm$core$List$any,
			$author$project$Main$overlapping(
				{x: newX, y: newY}),
			$author$project$Main$gameMapWalls);
		return hitByAnyBullets ? _Utils_update(
			enemy,
			{path: _List_Nil, x: $author$project$Main$enemyRespawn.x, y: $author$project$Main$enemyRespawn.y}) : (enemy.isLockedOn ? _Utils_update(
			enemy,
			{path: path, x: enemy.x + pathDx, y: enemy.y + pathDy}) : (((!isOldDirectionOverlappingWalls) && (_Utils_cmp(timeNow, enemy.changeDirectionTime) < 0)) ? _Utils_update(
			enemy,
			{x: oldX, y: oldY}) : ((!isNewDirectionOverlappingWalls) ? _Utils_update(
			enemy,
			{changeDirectionTime: timeNow + $author$project$Main$changeDirectionTime, direction: newDirection, x: newX, y: newY}) : enemy)));
	});
var $author$project$Main$updateEnemies = F4(
	function (timeNow, player, bullets, enemies) {
		return A2(
			$elm$core$List$map,
			A3($author$project$Main$updateEnemy, timeNow, player, bullets),
			enemies);
	});
var $author$project$Main$updateFood = F2(
	function (player, food) {
		return A2(
			$elm$core$List$filter,
			A2(
				$elm$core$Basics$composeL,
				$elm$core$Basics$not,
				$author$project$Main$overlapping(player)),
			food);
	});
var $author$project$Main$updatePlayer = F2(
	function (maybeNewDirection, player) {
		var newDirection = A2($elm$core$Maybe$withDefault, player.direction, maybeNewDirection);
		var _v0 = $author$project$Main$directionDeltas(player.direction);
		var oldDx = _v0.a;
		var oldDy = _v0.b;
		var _v1 = A3(
			$elm$core$Tuple$mapBoth,
			$author$project$Main$wrapAround,
			$author$project$Main$wrapAround,
			_Utils_Tuple2(player.x + oldDx, player.y + oldDy));
		var oldX = _v1.a;
		var oldY = _v1.b;
		var isOldDirectionOverlappingWalls = A2(
			$elm$core$List$any,
			$author$project$Main$overlapping(
				{x: oldX, y: oldY}),
			$author$project$Main$gameMapWalls);
		var _v2 = $author$project$Main$directionDeltas(newDirection);
		var newDx = _v2.a;
		var newDy = _v2.b;
		var _v3 = A3(
			$elm$core$Tuple$mapBoth,
			$author$project$Main$wrapAround,
			$author$project$Main$wrapAround,
			_Utils_Tuple2(player.x + newDx, player.y + newDy));
		var newX = _v3.a;
		var newY = _v3.b;
		var isNewDirectionOverlappingWalls = A2(
			$elm$core$List$any,
			$author$project$Main$overlapping(
				{x: newX, y: newY}),
			$author$project$Main$gameMapWalls);
		return (!isNewDirectionOverlappingWalls) ? _Utils_update(
			player,
			{direction: newDirection, x: newX, y: newY}) : ((!isOldDirectionOverlappingWalls) ? _Utils_update(
			player,
			{x: oldX, y: oldY}) : player);
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'AnimationFrame':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							bullets: A2($author$project$Main$updateBullets, model.enemies, model.bullets),
							enemies: A4($author$project$Main$updateEnemies, timeNow, model.player, model.bullets, model.enemies),
							food: A2($author$project$Main$updateFood, model.player, model.food),
							player: A2(
								$author$project$Main$updatePlayer,
								$author$project$Main$playerDirection(model.keysDown),
								model.player)
						}),
					$elm$core$Platform$Cmd$none);
			case 'KeyDown':
			...
			default:
				...
				var _v1 = A2(
					$elm$core$Maybe$map,
					A2($author$project$Main$Bullet, model.player.x, model.player.y),
					$author$project$Main$bulletDirection(key));
				if (_v1.$ === 'Nothing') {
...
var $author$project$Main$px = function (pixels) {
	return $elm$core$String$fromFloat(pixels) + 'px';
};
...
var $author$project$Main$onTouchEnd = function (msg) {
	return A2(
		$elm$html$Html$Events$on,
		'touchend',
		$elm$json$Json$Decode$succeed(msg));
};
var $author$project$Main$onTouchStart = function (msg) {
	return A2(
		$elm$html$Html$Events$on,
		'touchstart',
		$elm$json$Json$Decode$succeed(msg));
		...
		[
			...
			_List_fromArray(
				[
					...
					$author$project$Main$onTouchEnd(
					$author$project$Main$KeyUp('ArrowRight'))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('>')
			...
			_List_fromArray(
				[
					...
					$author$project$Main$onTouchEnd(
					$author$project$Main$KeyUp('ArrowUp'))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('^')
...
var $author$project$Main$viewGameOverMessage = function (isWin) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$viewBottom = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'left',
				$author$project$Main$px(x)),
				A2(
				$elm$html$Html$Attributes$style,
				'top',
				$author$project$Main$px(y)),
				A2(
				$elm$html$Html$Attributes$style,
				'width',
				$author$project$Main$px($author$project$Main$boxWidth)),
				A2(
				$elm$html$Html$Attributes$style,
				'height',
				$author$project$Main$px($author$project$Main$boxWidth)),
...
var $author$project$Main$viewBullets = function (bullets) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
			...
			function (_v0) {
				var x = _v0.x;
				var y = _v0.y;
				return $author$project$Main$viewBox(
					{color: 'cyan', x: x, y: y});
			},
			bullets));
};
var $author$project$Main$viewEnemies = function (enemies) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
			...
			function (enemy) {
				return $author$project$Main$viewBox(
					{color: 'red', x: enemy.x, y: enemy.y});
			},
			enemies));
};
var $author$project$Main$viewFood = function (food) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
...
var $author$project$Main$gameMapCharToColor = function (gameMapChar) {
	switch (gameMapChar.valueOf()) {
		case '#':
			return 'blue';
		case 'i':
			return '#ff00ff';
...
var $author$project$Main$viewGameMap = A2(
	$elm$html$Html$div,
	_List_Nil,
	A2(
		$elm$core$List$map,
		...
		A2(
			...
			function (r) {
				return {
					color: $author$project$Main$gameMapCharToColor(r._char),
					x: r.x,
					y: r.y
				};
			},
...
var $author$project$Main$viewPlayer = function (player) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewBox(
				{color: 'yellow', x: player.x, y: player.y}),
				(_Utils_cmp(player.x + $author$project$Main$boxWidth, $author$project$Main$gameWidth) > 0) ? $author$project$Main$viewBox(
				{
					color: 'yellow',
					x: $author$project$Main$wrapAround(player.x + $author$project$Main$boxWidth) - $author$project$Main$boxWidth,
					y: player.y
				}) : ((_Utils_cmp(player.y + $author$project$Main$boxWidth, $author$project$Main$gameWidth) > 0) ? $author$project$Main$viewBox(
				{
					color: 'yellow',
					x: player.x,
					y: $author$project$Main$wrapAround(player.y + $author$project$Main$boxWidth) - $author$project$Main$boxWidth
				}) : $elm$html$Html$text(''))
			]));
};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'position', 'relative'),
						A2($elm$html$Html$Attributes$style, 'border', '1px solid cyan'),
						A2(
						$elm$html$Html$Attributes$style,
						'width',
						$author$project$Main$px($author$project$Main$gameWidth)),
						A2(
						$elm$html$Html$Attributes$style,
						'height',
						$author$project$Main$px($author$project$Main$gameWidth)),
				...
				_List_fromArray(
					[
						$author$project$Main$viewGameMap,
						$author$project$Main$viewPlayer(model.player),
						$author$project$Main$viewFood(model.food),
						$author$project$Main$viewEnemies(model.enemies),
						$author$project$Main$viewBullets(model.bullets)
					])),
				$author$project$Main$viewBottom(model)
			]));
};
